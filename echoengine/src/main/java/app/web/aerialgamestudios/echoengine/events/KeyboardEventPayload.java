...
public class KeyboardEventPayload
{
	...
	public int type; // 0 for input, 1 for typing
	...
	// Typing ONLY
	public int typingCodepoint;

	public KeyboardEventPayload(int type, int inputAction, int inputKey, int typingCodepoint)
	{
		this.type = type;
		this.inputAction = inputAction;
		this.inputKey = inputKey;
		this.typingCodepoint = typingCodepoint;
	}
}
